...
library LzLib {
    ...
    function buildAdapterParams(LzLib.AirdropParams memory _airdropParams, uint256 _uaGasLimit) internal pure returns (bytes memory adapterParams) {
    ...
    function buildAirdropAdapterParams(uint256 _uaGas, AirdropParams memory _params) internal pure returns (bytes memory) {
...
contract LZEndpointMock is ILayerZeroEndpoint {
    ...
    function getConfig(uint16, /*_version*/ uint16, /*_chainId*/ address, /*_ua*/ uint256 /*_configType*/ ) external pure override returns (bytes memory) {
        return "";
    }
