...
import type {
  BaseOFTV2,
  BaseOFTV2Interface,
} from "../../../../contracts/layerZero/oft/BaseOFTV2";
...
export class BaseOFTV2__factory {
  ...
  static createInterface(): BaseOFTV2Interface {
    return new Interface(_abi) as BaseOFTV2Interface;
  }
  static connect(address: string, runner?: ContractRunner | null): BaseOFTV2 {
    return new Contract(address, _abi, runner) as unknown as BaseOFTV2;
  }
}
