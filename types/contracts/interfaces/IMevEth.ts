...
export interface IMevEthInterface extends Interface {
...
export interface IMevEth extends BaseContract {
  connect(runner?: ContractRunner | null): IMevEth;
  waitForDeployment(): Promise<this>;

  interface: IMevEthInterface;
